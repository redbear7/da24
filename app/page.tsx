    ...
    <div className="min-h-screen bg-background pb-6">
      ...
      <section className="max-w-[640px] mx-auto px-5 pb-5">
        <div className="grid grid-cols-2 border border-border rounded-xl overflow-hidden">
          <div className="py-3.5 text-center border-r border-border flex items-center justify-center gap-1.5">
            <span className="text-[15px] font-semibold text-text-muted">대출</span>
            <span className="text-[10px] font-medium text-text-muted bg-muted px-1.5 py-0.5 rounded-full">준비 중</span>
          </div>
          <div className="py-3.5 text-center flex items-center justify-center gap-1.5">
      ...
      <section className="max-w-[640px] mx-auto px-5 pb-6">
        ...
        >
          ...
          <p className="text-[17px] font-bold mt-0.5 pr-10">{BANNERS[bannerIdx].title}</p>
      ...
      <section className="max-w-[640px] mx-auto px-5 pb-8">
        <p className="text-[12px] text-text-muted font-medium mb-1">다이사의 사회 공헌 활동</p>
