  ...
  return (
    <footer className="bg-muted border-t border-border mt-4 pb-48">
      <div className="max-w-[640px] mx-auto px-5 py-6">
        <div className="text-[12px] text-text-muted leading-relaxed space-y-0.5">
          <p className="font-semibold text-text-secondary text-[13px]">(주)다이사</p>
        ...
        <p className="text-[11px] text-text-muted mt-1">&copy; {new Date().getFullYear()} DA24. All rights reserved.</p>
      </div>
    </footer>
  );
}
