export default function Footer() {
  return (
    <footer className="bg-white border-t border-border-main mt-8">
      <div className="max-w-[480px] mx-auto px-5 py-6">
        <div className="text-xs text-text-muted leading-relaxed space-y-1">
          <p className="font-semibold text-text-secondary">(주)다이사</p>
        ...
        <div className="flex gap-4 mt-4 pt-4 border-t border-border-subtle">
          ...
          <a href="#" className="text-xs text-text-muted hover:text-text-secondary font-bold">
            개인정보처리방침
          </a>
          <a href="#" className="text-xs text-text-muted hover:text-text-secondary">
            사업자정보
        ...
        <p className="text-[10px] text-text-muted mt-4">
          다이사는 통신판매중개자로서 거래 당사자가 아니며, 상품의 예약, 이용 및 환불 등과 관련한
          의무와 책임은 각 판매자에게 있습니다.
        </p>

        <p className="text-[10px] text-text-muted mt-2">
          &copy; {new Date().getFullYear()} DA24. All rights reserved.
        </p>
      </div>
    </footer>
  );
