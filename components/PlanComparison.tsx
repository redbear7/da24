        ...
        {filtered.map((plan) => {
          ...
          return (
            <button
              ...
              style={{
                boxShadow: isSelected ? undefined : "0 1px 8px rgba(0,0,0,0.05)",
              }}
            >
              {/* Popular badge */}
              {plan.isPopular && (
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="text-right">
                  <p className="text-[20px] font-extrabold text-primary">
                    ...
                    <span className="text-xs font-medium text-text-muted ml-0.5">원/월</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-border-subtle">
                <span className="text-xs text-text-muted">설치비 {plan.installFee.toLocaleString()}원</span>
